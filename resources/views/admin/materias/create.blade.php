            ...
            <form action="{{ route('admin.materias.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="descripcion"
                              id="descripcion"
                              rows="3"
                              class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('descripcion') border-red-500 @enderror"
                              placeholder="Descripción de la materia (opcional)">{{ old('descripcion') }}</textarea>
                    @error('descripcion')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    <label class="flex items-center">
                        <input type="checkbox"
                               name="tiene_auxiliar"
                               value="1"
                               {{ old('tiene_auxiliar', false) ? 'checked' : '' }}
